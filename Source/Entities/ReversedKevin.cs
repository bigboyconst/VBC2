...
{
    [CustomEntity("VBC2/ReversedKevin")]
    public class ReversedKevin : Solid
    {
        public enum Axes
        {
            Both,
        ...
        public ReversedKevin(Vector2 position, float width, float height, Axes axes, bool chillOut = false)
        ...
        public ReversedKevin(EntityData data, Vector2 offset)
